                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button"
                                    ...
                                    <img src="{{ asset('dashboard/uploads/profile') . '/' . Auth::user()->profile_photo }}"
                                        width="20" alt="profile photo" />
                                    <div class="header-info">
                                        <span
                                            class="text-black"><strong>{{ ucwords(Auth::user()->name) }}</strong></span>
            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('feature.create') }}">Add Features</a></li>
                            <li><a href="{{ route('feature.index') }}">Manage Features</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <div class="copyright">
                    <p><strong>Gymove Fitness Admin Dashboard</strong> © {{ Date('Y') }} All Rights Reserved</p>
                </div>
            </div>
        </div>
        @yield('content')
