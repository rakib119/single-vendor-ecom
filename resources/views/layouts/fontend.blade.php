...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('fontend') }}/css/plugins/nice-select.css" />
    <link rel="stylesheet" href="{{ asset('fontend') }}/css/plugins/venobox.css" />
    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <!-- <link rel="stylesheet" href="{{ asset('fontend') }}/css/vendor/vendor.min.css" />
    <link rel="stylesheet" href="{{ asset('fontend') }}/css/plugins/plugins.min.css" />
...
<body>
    ...
    <div class="header-to-bar"> ! 25% Off All Products </div>
    <header>
                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="{{ route('index') }}"><img src="{{ asset('fontend') }}/images/logo/logo.png"
                                    alt="Site Logo" /></a>
                        </div>
                    </div>
                                            ...
                                            <ul class="menu-banner w-100">
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            ...
                                                            src="{{ asset('fontend') }}/images/banner/7.jpg"
                                                            alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
                                                            src="{{ asset('fontend') }}/images/banner/8.jpg"
                                                            alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
                                                            src="{{ asset('fontend') }}/images/banner/9.jpg"
                                                            alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                ...
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img
                                src="{{ asset('fontend') }}/images/product-image/1.jpg" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img
                                src="{{ asset('fontend') }}/images/product-image/2.jpg" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img
                                src="{{ asset('fontend') }}/images/product-image/3.jpg" alt="Cart product Image"></a>
                        <div class="content">
                            ...
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <a href="{{ route('index') }}"><img
                                            src="{{ asset('fontend') }}/images/logo/logo-white.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('fontend') }}/images/product-image/zoom-image/1.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('fontend') }}/images/product-image/zoom-image/2.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('fontend') }}/images/product-image/zoom-image/3.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('fontend') }}/images/product-image/zoom-image/4.jpg"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-container zoom-thumbs mt-3 mb-3">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('fontend') }}/images/product-image/small-image/1.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('fontend') }}/images/product-image/small-image/2.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('fontend') }}/images/product-image/small-image/3.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('fontend') }}/images/product-image/small-image/4.jpg"
                                            alt="">
                                    </div>
                                </div>
                            </div>
    ...
    <script src="{{ asset('fontend') }}/js/vendor/jquery-migrate-3.3.2.min.js"></script>
    <script src="{{ asset('fontend') }}/js/vendor/modernizr-3.11.2.min.js"></script>

    <!--Plugins JS-->

    <script src="{{ asset('fontend') }}/js/plugins/swiper-bundle.min.js"></script>
    <script src="{{ asset('fontend') }}/js/plugins/jquery-ui.min.js"></script>
    <script src="{{ asset('fontend') }}/js/plugins/jquery.nice-select.min.js"></script>
    <script src="{{ asset('fontend') }}/js/plugins/countdown.js"></script>
    <script src="{{ asset('fontend') }}/js/plugins/scrollup.js"></script>
    <script src="{{ asset('fontend') }}/js/plugins/jquery.zoom.min.js"></script>
    <script src="{{ asset('fontend') }}/js/plugins/venobox.min.js"></script>
    <script src="{{ asset('fontend') }}/js/plugins/ajax-mail.js"></script>

    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <!-- <script src="{{ asset('fontend') }}/js/vendor/vendor.min.js"></script>
    <script src="{{ asset('fontend') }}/js/plugins/plugins.min.js"></script> -->
